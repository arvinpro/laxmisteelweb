              ...
              >
                <div style={{ fontSize: '18px' }} className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center text-brand-black font-sans">
                  <div className="lg:col-span-7 space-y-6">
                    <span className="text-xs uppercase font-condensed font-black tracking-widest text-[#B8001F] border-b border-brand-red/30 pb-2 inline-block">
                      Who We Are
                    </span>
                    ...
                    <Link
                      href={"/about"}
                      className="inline-flex items-center gap-2 text-[#B8001F] hover:text-[#B8001F]/80 uppercase font-condensed font-black text-xs tracking-wider cursor-pointer focus:outline-none"
                    >
                  ...
                  <div className="lg:col-span-5 flex justify-center">
                    <div className="border border-brand-border bg-white rounded-xs p-6 shadow-sm relative w-full max-w-sm hover:shadow-md transition-shadow">
                      <span className="absolute -top-3 -right-3 bg-brand-red text-white text-[9px] font-condensed font-black uppercase tracking-widest px-3 py-1 shrink-0">
                        ESTABLISHED 2008
                      </span>
                      <div className="space-y-4">
                        ...
                        <h3 className="font-serif text-lg font-bold">A Saurabh Group Conglomerate</h3>

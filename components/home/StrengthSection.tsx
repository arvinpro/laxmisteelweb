                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center text-brand-black">
                  <div className="lg:col-span-5 hidden lg:block">
                    <div className="bg-brand-darksky p-8 text-white max-w-sm rounded-xs border border-brand-skyaccent/30 space-y-4 shadow-xl">
                      <span className="text-lg text-brand-skytext font-bold block">Sunwal Rolling Mill Complex</span>
                      <h3 className="text-lg font-bold">Quenching is a science, not a guess.</h3>
                  ...
                  <div className="lg:col-span-7 space-y-6 text-xs md:text-sm">
                    <span className="text-base uppercase font-black tracking-widest text-brand-red border-b border-brand-red/35 pb-2 inline-block">
                      Where Strength is Engineered
                    </span>
                    
                    <h3 className="text-2xl md:text-3xl font-extrabold text-brand-black uppercase">From Billets to TMT Bars</h3>
                    
                    <div className="space-y-4 text-brand-muted">
                      <div className="flex gap-3 leading-normal">
                        <span className="font-bold text-brand-red text-base">01.</span>
                        <p><strong>Prime Billet Selection:</strong> Low impurity, refined raw casts compliant completely with chemical carbon quotas.</p>
                      </div>
                      <div className="flex gap-3 leading-normal">
                        <span className="font-bold text-brand-red text-base">02.</span>
                      ...
                      <div className="flex gap-3 leading-normal">
                        <span className="font-bold text-brand-red text-base">03.</span>
                      ...
                      <div className="flex gap-3 leading-normal">
                        <span className="font-bold text-brand-red text-base">04.</span>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 text-brand-red hover:text-brand-red/80 font-black px-4 py-2 uppercase text-sm tracking-wider cursor-pointer focus:outline-none"
                    >
